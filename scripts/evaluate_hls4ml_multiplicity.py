...
MODEL_SPECS = {
    ...
    "salt": ModelSpec(
        ...
        "tensorflow",
        (
            "/j-jepa-vol/1p3mFLOPs_runs/salt/trial-0/150/kt/trial-5/best.weights.h5",
            "/j-jepa-vol/1p3mFLOPs_runs/salt/trial-1/150/kt/trial-8/best.weights.h5",
            "/j-jepa-vol/1p3mFLOPs_runs/salt/trial-2/150/kt/trial-5/best.weights.h5",
        ),
        2048,
    ),
    "linformer": ModelSpec(
        ...
        "tensorflow",
        (
            "/j-jepa-vol/1p3mFLOPs_runs/linformer/trial-0/150/kt/trial-6/best.weights.h5",
            "/j-jepa-vol/1p3mFLOPs_runs/linformer/trial-1/150/kt/trial-3/best.weights.h5",
            "/j-jepa-vol/1p3mFLOPs_runs/linformer/trial-2/150/kt/trial-4/best.weights.h5",
        ),
        2048,
    ),
    "pointnet": ModelSpec(
        ...
        "tensorflow",
        (
            "/j-jepa-vol/1p3mFLOPs_runs/pointnet/trial-0/150/kt/trial-2/best.weights.h5",
            "/j-jepa-vol/1p3mFLOPs_runs/pointnet/trial-1/150/kt/trial-3/best.weights.h5",
            "/j-jepa-vol/1p3mFLOPs_runs/pointnet/trial-2/150/kt/trial-3/best.weights.h5",
        ),
        4096,
    ),
    "part_full": ModelSpec(
...
def make_tensorflow_model(model_name: str):
    ...
    if model_name in {"salt", "linformer"}:
        ...
        return build_linformer_transformer_classifier(
            150,
            3,
            d_model=16 if is_salt else 24,
            d_ff=40 if is_salt else 24,
            output_dim=5,
            num_heads=4,
            proj_dim=6 if is_salt else 3,
            use_cpe=True,
            cpe_k=8,
            grid_size=0.2,
            cluster_E=is_salt,
